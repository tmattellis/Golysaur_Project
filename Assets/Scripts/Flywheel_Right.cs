...
public class Flywheel_Right : MonoBehaviour
{
	...
	//void Start() 
	//{
	//	transform.position = Waypoints[CurrentIdx].transform.position;
	//   }
	...
	//   void Move()
	//{
	//	transform.position = Vector2.MoveTowards(transform.position, Waypoints[CurrentIdx].transform.position, speed);

	//       if (transform.position == Waypoints[CurrentIdx].transform.position)
	//	{
	//		CurrentIdx += 1;
	//	}
